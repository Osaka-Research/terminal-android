...
public final class TermuxPreferenceConstants {
    ...
    public static final class TERMUX_APP {
        ...
        /**
         * Defines the key for whether the first-run permission onboarding wizard has been
         * completed (or explicitly skipped) at least once.
         */
        public static final String KEY_ONBOARDING_COMPLETED = "onboarding_completed";
        public static final boolean DEFAULT_VALUE_ONBOARDING_COMPLETED = false;


        /**
         * Defines the key for the URL of the update manifest JSON to check for app updates
         * against (self-hosted, not Play Store -- see UpdateChecker for the expected shape).
         * Empty means updates are not configured.
         */
        public static final String KEY_UPDATE_CHECK_URL = "update_check_url";
        public static final String DEFAULT_VALUE_UPDATE_CHECK_URL = "";

        /** Defines the key for whether to automatically check {@link #KEY_UPDATE_CHECK_URL} periodically. */
        public static final String KEY_UPDATE_AUTO_CHECK_ENABLED = "update_auto_check_enabled";
        public static final boolean DEFAULT_VALUE_UPDATE_AUTO_CHECK_ENABLED = false;

        /** Defines the key for the epoch millis timestamp of the last update check, successful or not. */
        public static final String KEY_UPDATE_LAST_CHECKED_AT = "update_last_checked_at";
        public static final long DEFAULT_VALUE_UPDATE_LAST_CHECKED_AT = 0L;
