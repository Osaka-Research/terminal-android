...
public class TermuxAppSharedPreferences extends AppSharedPreferences {
    ...
    public boolean isOnboardingCompleted() {
        return SharedPreferenceUtils.getBoolean(mSharedPreferences, TERMUX_APP.KEY_ONBOARDING_COMPLETED, TERMUX_APP.DEFAULT_VALUE_ONBOARDING_COMPLETED);
    }

    public void setOnboardingCompleted(boolean value) {
        SharedPreferenceUtils.setBoolean(mSharedPreferences, TERMUX_APP.KEY_ONBOARDING_COMPLETED, value, false);
    }

    public String getUpdateCheckUrl() {
        return SharedPreferenceUtils.getString(mSharedPreferences, TERMUX_APP.KEY_UPDATE_CHECK_URL, TERMUX_APP.DEFAULT_VALUE_UPDATE_CHECK_URL, false);
    }

    public void setUpdateCheckUrl(String value) {
        SharedPreferenceUtils.setString(mSharedPreferences, TERMUX_APP.KEY_UPDATE_CHECK_URL, value, false);
    }

    public boolean isUpdateAutoCheckEnabled() {
        return SharedPreferenceUtils.getBoolean(mSharedPreferences, TERMUX_APP.KEY_UPDATE_AUTO_CHECK_ENABLED, TERMUX_APP.DEFAULT_VALUE_UPDATE_AUTO_CHECK_ENABLED);
    }

    public void setUpdateAutoCheckEnabled(boolean value) {
        SharedPreferenceUtils.setBoolean(mSharedPreferences, TERMUX_APP.KEY_UPDATE_AUTO_CHECK_ENABLED, value, false);
    }

    public long getUpdateLastCheckedAt() {
        return SharedPreferenceUtils.getLong(mSharedPreferences, TERMUX_APP.KEY_UPDATE_LAST_CHECKED_AT, TERMUX_APP.DEFAULT_VALUE_UPDATE_LAST_CHECKED_AT);
    }

    public void setUpdateLastCheckedAt(long value) {
        SharedPreferenceUtils.setLong(mSharedPreferences, TERMUX_APP.KEY_UPDATE_LAST_CHECKED_AT, value, false);
    }
