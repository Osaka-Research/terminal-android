...
public final class TermuxConstants {
    ...
    /** Termux app notification channel id used for app update availability */
    public static final String TERMUX_UPDATE_NOTIFICATION_CHANNEL_ID = "termux_update_notification_channel";
    /** Termux app notification channel name used for app update availability */
    public static final String TERMUX_UPDATE_NOTIFICATION_CHANNEL_NAME = TermuxConstants.TERMUX_APP_NAME + " Updates";
    /** Termux app unique notification id used for app update availability */
    public static final int TERMUX_UPDATE_NOTIFICATION_ID = 1340;
